...
namespace komp
{
class DrawableCurve : public Drawable, public ItemObserver
{
public:
    DrawableCurve();
    virtual ~DrawableCurve() = default;
...
private:
    void setPoints(const Point& inLeft,
    ...
    mutable DrawableRectangle mDrawableCPStart;
    mutable DrawableRectangle mDrawableCPEnd;
    
    mutable Point mLeft;
    mutable Point mLeftInner;
    mutable Point mRightInner;
    mutable Point mRight;
};
