...
namespace komp
{
    class KOMP_EXPORT Marker : public Spatial
    {
    public:
        Marker(const MusicLocation& inLocation,
               const MarkerParams& inParams);
        Marker(const Marker& inObject);
    ...
    private:
        ...
        void copyState(const Marker& other);
        void configure(const MarkerParams& inParams);
