...
public:
    ...
    virtual bool getIsSlowTest() const { return false; }
...
{\
    if (!(condition)) { \
        rEsUlT_.addFailure (Failure (#condition, __FILE__, __LINE__, getName())); \
        return; \
    }\
}
...
{\
    ...
    if (_expected != _actual) {\
        ...
        rEsUlT_.addFailure (Failure (message.str(), __FILE__, __LINE__, getName()));\
        return; \
    }\
}
...
{\
    rEsUlT_.addFailure (Failure ((text), __FILE__, __LINE__, getName())); \
    return; \
}
...
{\
    ...
    {\
        ...
        rEsUlT_.addFailure (Failure (message.str().c_str(), __FILE__, __LINE__, getName())); \
        return; \
    }\
}
...
{                                                                     \
    if (!(bOoLeAn))                                                   \
    {                                                                 \
        rEsUlT_.addFailure (Failure (mEsSaGe, __FILE__, __LINE__, getName()));  \
        return;                                                       \
    }                                                                 \
}                                                                     \
